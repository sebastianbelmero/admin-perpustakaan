<div>
	...
	<button onclick="return confirm('Apakah anda yakin ingin menghapus kelas???') || event.stopImmediatePropagation()" wire:click="hapusKelas({{ $idnya }})" class="px-2 py-1 bg-red-500 hover:bg-red-700 rounded text-white"><i class="bi bi-trash"></i> Hapus</button>
